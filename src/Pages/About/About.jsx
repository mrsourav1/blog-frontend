            ...
            <div className='text-center mb-4'><h2><strong>Our Team</strong></h2></div>
                ...
                <div className="row d-flex justify-content-center align-items-evenly">
                    <div className="col-12 col-md-6 col-lg-4 mb-4 d-flex flex-column">
                        <div>
                           <img className='img-fluid' src="./assets/image/gallery/IMG_8472.jpg" style={{height:'350px', width:'400px'}} alt='gallery' />
                        </div>
                       <div>
                    ...
                    <div className="col-12 col-md-6 col-lg-4 mb-4 d-flex flex-column">
                        <div>
                           <img className='img-fluid' src="./assets/image/gallery/IMG-8471.jpg" style={{height:'350px', width:'500px'}} alt='gallery'/>
                        </div>
                        <div>
